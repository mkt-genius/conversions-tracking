# How to use Mkt-Genius tracking with stages
...
/* Mkt-Genius tracking code start */
(function() {
    "use strict";
...
$('.btn-subscribe').on('click', function() {
    /* Mkt-Genius conversion stage tracking start */
    var CONVERSION_STAGE = "2";
    window.trackingConversion(CONVERSION_STAGE);
    /* Mkt-Genius conversion stage tracking end */
});
```
